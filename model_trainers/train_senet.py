...
def main(args):
    ...
    # train_set = dataset.EnsembleHecktorDataset(train_paths, transforms=train_transforms)
    # val_set = dataset.EnsembleHecktorDataset(val_paths, transforms=val_transforms)
